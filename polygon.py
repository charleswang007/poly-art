...
# source: https://cosmiccoding.com.au/tutorials/lowpoly

inp = pygame.surfarray.pixels3d(pygame.image.load("lowpoly/tiger.jpg"))
...
for i in range(0, 100):
    ...
    pygame.image.save(s, f"lowpoly/output/tiger/{i:04d}.png")